...
<form className=" container w-50 mx-auto my-56 " onSubmit={handleSubmit}>
  ...
  <input className="form-check-input" name="gender" type="radio"   value="Male"  onChange={getUserData}/>
  <label className="form-check-label" >
    Male
  </label>
{/* </div>
<div className="  Btnradio"> */}
  <input className="form-check-input" name="gender"  type="radio" value="Female"  checked onChange={getUserData}/>
  <label className="form-check-label" >
    Female
  </label>
</div>
